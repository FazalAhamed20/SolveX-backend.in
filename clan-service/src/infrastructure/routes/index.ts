...
export const routes = (dependencies:IDependencies) => {
  const{createClan,fetchAllMember,fetchAllUsers,addMember,deleteMember,blockClan,leaveClan,requestClan,acceptClan,completeQuiz,rejectClan}=controller(dependencies)
